...
from get_genera_lists import get_genera, get_g_spore
from get_species_lists import get_species, get_s_spore
...
a_options = ["spore forming", "non-spore forming", "mixed"]
a_colors = [green, blue, yellow]
