...
from get_genera_lists import get_genera, get_g_bile
from get_species_lists import get_species, get_s_bile

#create or define all needed lists
lins = create_lin_list()
genera = get_genera()
species = get_species()
g_phen = g_bile = get_g_bile()
s_phen = s_bile = get_s_bile()
nodes = []
edges = []
...
a_options = ["growth in 20% bile", "no growth in 20% bile", "somewhat inhibited by 20% bile", "mixed", "growth in 2% bile"]
a_colors = [green, red, redorange, yellow, pink]
