...
from get_genera_lists import get_genera, get_g_gram
from get_species_lists import get_species, get_s_gram

#create or define all needed lists
lins = create_lin_list()
genera = get_genera()
species = get_species()
g_phen = g_gram = get_g_gram()
s_phen = s_gram = get_s_gram()
nodes = []
edges = []
...
a_options = ["Gram-positive", "Gram-negative", "Gram-variable"]
a_colors = [light_purple, blue, redorange]
