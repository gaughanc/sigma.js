...
genera = ["Bacteroides", "Blautia", "Dorea", "Prevotella"]
species = [["Bacteroides acidifaciens", "Bacteroides caccae"], ["Blautia coccoides"], [], ["Prevotella corpri", "Prevotella mulitformis", "Prevotella oris"]]
nodes = []
edges = []
node_color = "#ec5148"
edge_color = "#f28f8a"
